...
public class RemoveLinhas {
    ...
    public static void main(String[] args) {
        try {
            ...
            File arquivoEntrada = new File("/home/esley/Documentos/Intellij/textfiles/exercise08/meuarquivo.txt");
            BufferedReader leitor = new BufferedReader(new FileReader(arquivoEntrada));

            File arquivoSaida = new File("/home/esley/Documentos/Intellij/textfiles/exercise08/meuarquivo_sem_excluir.txt");
